 ...
 */
// todo #define S_CURVE_ACCELERATION
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -17, -44, -0.87 }
...
#define XY_PROBE_FEEDRATE    (100*120) // (mm/min)
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (1*60) }
